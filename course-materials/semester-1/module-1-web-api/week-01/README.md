...
## Технологический стек недели
- Python 3.14+
- aiohttp 3.x — базовый HTTP-фреймворк курса (сервер и клиент)
- asyncpg — подключение к PostgreSQL без ORM
- pytest, pytest-aiohttp — тестирование
