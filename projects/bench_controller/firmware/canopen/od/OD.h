...
typedef struct {
    ...
    /* bench_controller: прикладные переменные мастера (LOS-76).
     * 0x2110/0x2111 — команда клапану (TPDO1), 0x2120..0x2122 —
     * обратная связь от узла клапана (RPDO1). */
    int16_t x2110_valveSetpoint;
    uint8_t x2111_controlWord;
    int16_t x2120_actualForce;
    int16_t x2121_actualPosition;
    uint8_t x2122_valveStatus;
} OD_RAM_t;
...
#define OD_ENTRY_H2120 &OD->list[35]
#define OD_ENTRY_H2121 &OD->list[36]
#define OD_ENTRY_H2122 &OD->list[37]
...
#define OD_ENTRY_H2110_valveSetpoint &OD->list[33]
#define OD_ENTRY_H2111_controlWord &OD->list[34]
#define OD_ENTRY_H2120_actualForce &OD->list[35]
#define OD_ENTRY_H2121_actualPosition &OD->list[36]
#define OD_ENTRY_H2122_valveStatus &OD->list[37]
