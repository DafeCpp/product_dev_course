...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1016_consumerHeartbeatTime = {0x002000C8, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},
    ...
    .x1280_SDOClientParameter = {
        ...
        .COB_IDClientToServerTx = 0x00000620,
        .COB_IDServerToClientRx = 0x000005A0,
        .node_IDOfTheSDOServer = 0x20
    },
    ...
    .x1600_RPDOMappingParameter = {
        ...
        .applicationObject2 = 0x21210010,
        .applicationObject3 = 0x21220008,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2110_valveSetpoint = 0,
    .x2111_controlWord = 0x00,
    .x2120_actualForce = 0,
    .x2121_actualPosition = 0,
    .x2122_valveStatus = 0x00
};
...
typedef struct {
    ...
    OD_obj_var_t o_2110_valveSetpoint;
    OD_obj_var_t o_2111_controlWord;
    OD_obj_var_t o_2120_actualForce;
    OD_obj_var_t o_2121_actualPosition;
    OD_obj_var_t o_2122_valveStatus;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2110_valveSetpoint = {
        .dataOrig = &OD_RAM.x2110_valveSetpoint,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2111_controlWord = {
        .dataOrig = &OD_RAM.x2111_controlWord,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2120_actualForce = {
        .dataOrig = &OD_RAM.x2120_actualForce,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2121_actualPosition = {
        .dataOrig = &OD_RAM.x2121_actualPosition,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2122_valveStatus = {
        .dataOrig = &OD_RAM.x2122_valveStatus,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2110, 0x01, ODT_VAR, &ODObjs.o_2110_valveSetpoint, NULL},
    {0x2111, 0x01, ODT_VAR, &ODObjs.o_2111_controlWord, NULL},
    {0x2120, 0x01, ODT_VAR, &ODObjs.o_2120_actualForce, NULL},
    {0x2121, 0x01, ODT_VAR, &ODObjs.o_2121_actualPosition, NULL},
    {0x2122, 0x01, ODT_VAR, &ODObjs.o_2122_valveStatus, NULL},
