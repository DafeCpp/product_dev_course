...
Сервис развивается итеративно; актуальные задачи ведутся в [Linear](https://linear.app/lostpointer).
