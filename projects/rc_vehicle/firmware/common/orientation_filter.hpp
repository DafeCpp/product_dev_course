...
class IOrientationFilter {
 public:
   ...
   *
   * Курс (yaw) в новой СК реализация задаёт сама. MadgwickFilter в 9DOF
   * засевает его из последнего mag-семпла, поэтому после калибровки yaw ≈
   * текущему магнитному курсу, а не нулю (LOS-221); нулю равны только
   * pitch/roll. В 6DOF абсолютной опоры у курса нет и yaw обнуляется.
   *
