...
- [x] Данные фильтрации и статус калибровки доступны в телеметрии через WebSocket (ориентация pitch/roll/yaw, статус калибровки, bias, gravity_vec, forward_vec; фильтрованный gyro — после реализации LPF)
