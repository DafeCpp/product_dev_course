...
## 5) IMU
- Установить **MPU‑6500** (или ожидаемый LSM6DS3/ICM‑20948) на шасси жёстко (минимум вибраций), согласовать оси.
...
**Основной вариант — LSM6DS3 (ожидается):**
- **Датчик:** LSM6DS3 (6‑DOF: акселерометр + гироскоп)
...
- **Интеграция:** драйвер `Lsm6ds3Driver` для ESP32‑S3
- **Статус:** задача в [LOS-158 — Интеграция LSM6DS3 (6-DOF IMU)](https://linear.app/lostpointer/issue/LOS-158), ожидается поставка
...
- **Назначение:** полная замена MPU‑6500/LSM6DS3, компенсация дрейфа yaw, абсолютный heading
- **Подключение:** I2C или SPI к ESP32‑S3
- **Статус:** задача в [LOS-159 — Интеграция ICM-20948 (9-DOF IMU)](https://linear.app/lostpointer/issue/LOS-159)

**Резервный вариант — MMC5983MA (если нужен отдельный магнитометр):**
- **Датчик:** MMC5983MA (3-осевой магнитометр) в паре с LSM6DS3
- **Назначение:** компенсация дрейфа yaw ( LSM6DS3 остаётся для accel/gyro)
- **Преимущество:** более высокая частота магнитометра (1000 Гц)
- **Статус:** задача в [LOS-160 — Интеграция магнитометра MMC5983](https://linear.app/lostpointer/issue/LOS-160)
...
- Основная задача: [LOS-158 — LSM6DS3, 6-DOF IMU](https://linear.app/lostpointer/issue/LOS-158)
- Альтернатива: [LOS-159 — ICM‑20948, 9-DOF IMU](https://linear.app/lostpointer/issue/LOS-159)
- Дополнение: [LOS-160 — MMC5983MA, магнитометр](https://linear.app/lostpointer/issue/LOS-160)
