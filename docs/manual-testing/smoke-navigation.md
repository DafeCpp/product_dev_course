...
**Факт (2026-07-16):** ✅ Регресс не воспроизводится — прямой заход на `/projects` (Playwright MCP) отрисовался полностью, без `500`, консоль чистая. Похоже, зафиксировано отдельным фиксом после 2026-06-10 (в этом прогоне отдельный коммит-фикс не искали).
