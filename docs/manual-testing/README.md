...
Отчёты о прохождениях — в [`test-reports.md`](test-reports.md) (новые сверху). Последний: **2026-07-18** — повторный прогон после фиксов; все 5 багов workstream'а LOS-182 подтверждены исправленными живьём: [LOS-190](https://linear.app/lostpointer/issue/LOS-190) (audit-writes 404), [LOS-191](https://linear.app/lostpointer/issue/LOS-191) (System Roles Permissions пустые), [LOS-192](https://linear.app/lostpointer/issue/LOS-192) (stale project_id после logout), [LOS-193](https://linear.app/lostpointer/issue/LOS-193) (смена пароля), [LOS-195](https://linear.app/lostpointer/issue/LOS-195) (audit-log response contract — найден и закрыт в рамках этого же повторного прогона). Предыдущий: 2026-07-16 — сквозной happy path + smoke по всем новым разделам (LOS-182), первое обнаружение LOS-190…193. Ранее: 2026-06-10 — auth-флоу (OK) + smoke-навигация, [BUG-F-013](https://linear.app/lostpointer/issue/LOS-6/bug-f-013-projects-page-returns-http-500-on-direct-load-f5-reload) (закрыт, не воспроизводится), [BUG-F-014](https://linear.app/lostpointer/issue/LOS-7/bug-f-014-webhooks-page-sends-requests-without-project-id-400-bad).
