...
> Актуальный статус задач и прогресс ведутся в [Linear](https://linear.app/lostpointer).
...
- **Инженер устройств (Device Integrator):** ✅ регистрирует датчики, настраивает подключение; sensor-simulator позволяет тестировать.
