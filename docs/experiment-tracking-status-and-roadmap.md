...
- **Документация:** ✅ (индекс `docs/README.md`, quickstart `docs/local-dev-docker-setup.md`, demo `docs/demo-flow.md`, сценарии ручного тестирования `docs/manual-testing/`, дебаг `docs/ui-debugging.md`)
